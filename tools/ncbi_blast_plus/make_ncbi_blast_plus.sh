...
tar -rf ncbi_blast_plus.tar test-data/blastn_chimera_vs_three_human_max1.txt
tar -rf ncbi_blast_plus.tar test-data/blastn_chimera_vs_three_human_max1.tabular
...
tar -rf ncbi_blast_plus.tar test-data/three_human_mRNA.fasta.nhd
...
tar -rf ncbi_blast_plus.tar test-data/chimera.fasta
...
#Check the output
echo "Expect a tar-ball with 117 files, have:"
